...
const client = new Discord.Client("NTIwNjkzODQzODA1NjAxODAx.YHtzLg.mwBc_ijcLYnGXecbojcqU3TNHRw");
const adminprefix = "-"
...
client.on('message', function(message) {
  ...
  client.on('message',async message => {
    if(message.content.startsWith(adminprefix + "restart")) {
        if(message.author.id !== "520693843805601801") return message.reply('You aren\'t the bot owner.');
